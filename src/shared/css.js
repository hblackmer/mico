export const CSS = [
    {
        ...
        answer: "CSS is a language for specifying how documents are presented to users.",
    ...
    },
    {
        ...
        answer: "The float property specifies whether an element should float to the left, right, or not at all.",
